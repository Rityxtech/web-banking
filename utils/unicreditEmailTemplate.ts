...
export const getUnicreditEmailTemplate = (data: any, lang?: string) => `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body style="margin: 0; padding: 0; background-color: #ffffff;">
    ...
    <div class="email-container">
            <div class="header" style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
                ${(() => {
                    const logoUrl = resolveLogoUrl(data.logo_url, '/unicredit-logo.png');
                    return logoUrl
                        ? `<img src="${logoUrl}" alt="UniCredit" class="logo" style="width: 85px; height: auto; background: transparent; margin-right: 40px;">`
                        : `<div class="logo" style="width: 85px; height: auto; background: transparent; margin-right: 40px; font-size: 14px; font-weight: bold; color: #ffffff;">UniCredit</div>`;
                })()}
                <div class="bank-info" style="text-align: right;">
                    <div class="bank-name">UniCredit</div>
                    <div><span style="color: #ffffff !important; text-decoration: none !important;">notifications@unicredit.com</span></div>
                    <div>${t('call', lang)}: +39 02 8862 1</div>
                </div>
            </div>
            ...
            <div class="security-section">
                ...
                <p style="margin: 0;">${t('security_notice_text', lang).replace('{bank}', 'UniCredit')}</p>
            </div>

            <div style="font-size: 10px; color: #666666; text-align: center; border-top: 1px solid #dddddd; padding-top: 10px;">
                <p style="margin: 0 0 4px 0;">${t('automated_notification', lang).replace('{bank}', 'UniCredit')}</p>
                <p style="margin: 0 0 4px 0;">&copy; ${new Date().getFullYear()} UniCredit. ${t('all_rights_reserved', lang)}.</p>
