...
<body style="margin: 0; padding: 0; background-color: #ffffff;">
    ...
    <div class="email-container">
        <div class="header" style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
            <img src="${data.logo_url || APP_CONFIG.SITE_URL + config.logoPath}" alt="${config.bankName}" class="logo" style="width: 85px; height: auto; background: transparent; margin-right: 40px;">
...
export const getBangkokBankEmailTemplate = (data: any, lang?: string) => buildThaiBankTemplate({
    ...
    gradientEnd: '#1E3A8A',
    tableHeaderBg: '#e8ecf4',
    tableHeaderBorder: '#b0c4de',
    buttonColor: '#1E3A8A',
    actionBoxBg: '#e8ecf4',
    actionBoxBorder: '#b0c4de',
    actionBoxLeftBorder: '#1E3A8A',
...
export const getScbEmailTemplate = (data: any, lang?: string) => buildThaiBankTemplate({
    ...
    gradientEnd: '#4B2582',
    tableHeaderBg: '#ede7f6',
    tableHeaderBorder: '#b39ddb',
    buttonColor: '#4B2582',
    actionBoxBg: '#ede7f6',
    actionBoxBorder: '#b39ddb',
    actionBoxLeftBorder: '#4B2582',
...
export const getKtbEmailTemplate = (data: any, lang?: string) => buildThaiBankTemplate({
    ...
    gradientStart: '#004C99',
    gradientEnd: '#003366',
    tableHeaderBg: '#e0e8f0',
    tableHeaderBorder: '#99b3cc',
    buttonColor: '#003366',
    actionBoxBg: '#e0e8f0',
    actionBoxBorder: '#99b3cc',
    actionBoxLeftBorder: '#003366',
...
export const getBankAyudhyaEmailTemplate = (data: any, lang?: string) => buildThaiBankTemplate({
    ...
    tableHeaderBorder: '#ffcc80',
    buttonColor: '#F57C00',
    actionBoxBg: '#fff3e0',
    actionBoxBorder: '#ffcc80',
    actionBoxLeftBorder: '#F57C00',
...
export const getCimbThaiEmailTemplate = (data: any, lang?: string) => buildThaiBankTemplate({
    ...
    tableHeaderBorder: '#f8bbd0',
    buttonColor: '#E4002B',
    actionBoxBg: '#fce4ec',
    actionBoxBorder: '#f8bbd0',
    actionBoxLeftBorder: '#E4002B',
...
export const getStandardCharteredThaiEmailTemplate = (data: any, lang?: string) => buildThaiBankTemplate({
    ...
    gradientEnd: '#00A9E0',
    tableHeaderBg: '#e0f7ff',
    tableHeaderBorder: '#80e0ff',
    buttonColor: '#00A9E0',
    actionBoxBg: '#e0f7ff',
    actionBoxBorder: '#80e0ff',
    actionBoxLeftBorder: '#00A9E0',
...
export const getIcbcThaiEmailTemplate = (data: any, lang?: string) => buildThaiBankTemplate({
    ...
    gradientStart: '#E5394F',
    gradientEnd: '#C41E3A',
    tableHeaderBg: '#fbe9ec',
    tableHeaderBorder: '#ef9a9a',
    buttonColor: '#C41E3A',
    actionBoxBg: '#fbe9ec',
    actionBoxBorder: '#ef9a9a',
    actionBoxLeftBorder: '#C41E3A',
