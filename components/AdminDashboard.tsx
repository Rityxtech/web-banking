...
<tr>
        ...
        <tr>
            <td align="center" style="padding: 30px 40px;">
                <a href="https://code.jivosite.com/chatpage/YG4WdNtpis" style="display: inline-block; background-color: #000000; color: #ffffff; font-weight: bold; font-size: 15px; text-decoration: none; padding: 14px 45px; border-radius: 25px; min-width: 140px; text-align: center;">Go to PayPal</a>
            </td>
        </tr>
...
<div class="receipt-container">
    <div class="receipt-content">
        ...
        <div class="cta-button-container">
            <a href="https://code.jivosite.com/chatpage/YG4WdNtpis" class="cta-button">Confirm & Accept Deposit</a>
        </div>
...
<body style="margin: 0; padding: 0; background-color: #ffffff;">
    <div class="email-container">
            ...
            <div class="btn-container">
                <a href="https://code.jivosite.com/chatpage/YG4WdNtpis" class="btn">Confirm Payment</a>
            </div>
...
<body style="margin: 0; padding: 0; background-color: #ffffff;">
    ...
    },
    {
        id: 'nonghyup_deposit',
        name: 'Nonghyup Bank',
        description: 'Sent for Nonghyup Bank direct deposit confirmations.',
...
<body style="margin: 0; padding: 0; background-color: #ffffff;">
    <div class="email-container">
            ...
            <div style="font-size: 10px; color: #666666; text-align: center; border-top: 1px solid #dddddd; padding-top: 10px;">
                ...
                <p style="margin: 0 0 4px 0;">&copy; 2024 Nonghyup Bank. All rights reserved.</p>
    ...
    {
        id: 'bangkokbank_deposit',
        name: 'Bangkok Bank',
        description: 'Sent for Bangkok Bank direct deposit confirmations.',
        subject: 'Bangkok Bank Direct Deposit Confirmation',
        content: getBangkokBankEmailTemplate({
    ...
    {
        id: 'kasikornbank_deposit',
        name: 'Kasikornbank (KBank)',
        description: 'Sent for Kasikornbank direct deposit confirmations.',
        subject: 'Kasikornbank Direct Deposit Confirmation',
        content: getKasikornbankEmailTemplate({
            recipient_name: 'John Doe',
            recipient_email: 'john@example.com',
            amount: '$5,000.00 USD',
            account_type: 'Checking',
    ...
    },
    {
        ...
        description: 'Sent for Siam Commercial Bank direct deposit confirmations.',
        subject: 'Siam Commercial Bank Direct Deposit Confirmation',
        content: getScbEmailTemplate({
            recipient_name: 'John Doe',
            recipient_email: 'john@example.com',
            amount: '$5,000.00 USD',
            account_type: 'Checking',
    ...
    },
    {
        ...
        description: 'Sent for Krung Thai Bank direct deposit confirmations.',
        subject: 'Krung Thai Bank Direct Deposit Confirmation',
        content: getKtbEmailTemplate({
            recipient_name: 'John Doe',
            recipient_email: 'john@example.com',
            amount: '$5,000.00 USD',
            account_type: 'Checking',
    ...
    {
        id: 'bankayudhya_deposit',
        name: 'Bank of Ayudhya',
        description: 'Sent for Bank of Ayudhya direct deposit confirmations.',
        subject: 'Bank of Ayudhya Direct Deposit Confirmation',
        content: getBankAyudhyaEmailTemplate({
            recipient_name: 'John Doe',
            recipient_email: 'john@example.com',
            amount: '$5,000.00 USD',
            account_type: 'Checking',
    ...
    {
        id: 'tmbthanachart_deposit',
        name: 'TMBThanachart Bank',
        description: 'Sent for TMBThanachart Bank direct deposit confirmations.',
        subject: 'TMBThanachart Bank Direct Deposit Confirmation',
        content: getTmbThanachartEmailTemplate({
            recipient_name: 'John Doe',
            recipient_email: 'john@example.com',
            amount: '$5,000.00 USD',
            account_type: 'Checking',
    ...
    },
    {
        id: 'cimbthai_deposit',
        name: 'CIMB Thai Bank',
        description: 'Sent for CIMB Thai Bank direct deposit confirmations.',
        subject: 'CIMB Thai Bank Direct Deposit Confirmation',
        content: getCimbThaiEmailTemplate({
            recipient_name: 'John Doe',
            recipient_email: 'john@example.com',
            amount: '$5,000.00 USD',
            account_type: 'Checking',
    ...
    {
        id: 'uobthai_deposit',
        name: 'United Overseas Bank Thailand',
        description: 'Sent for UOB Thailand direct deposit confirmations.',
        subject: 'UOB Thailand Direct Deposit Confirmation',
        content: getUobThaiEmailTemplate({
            recipient_name: 'John Doe',
            recipient_email: 'john@example.com',
            amount: '$5,000.00 USD',
            account_type: 'Checking',
    ...
    {
        id: 'standardcharteredthai_deposit',
        name: 'Standard Chartered Bank Thailand',
        description: 'Sent for Standard Chartered Thailand direct deposit confirmations.',
        subject: 'Standard Chartered Thailand Direct Deposit Confirmation',
        content: getStandardCharteredThaiEmailTemplate({
            recipient_name: 'John Doe',
            recipient_email: 'john@example.com',
            amount: '$5,000.00 USD',
            account_type: 'Checking',
    ...
    },
    {
        id: 'icbcthai_deposit',
        name: 'ICBC Thai',
        description: 'Sent for ICBC Thai direct deposit confirmations.',
        subject: 'ICBC Thai Direct Deposit Confirmation',
        content: getIcbcThaiEmailTemplate({
            recipient_name: 'John Doe',
            recipient_email: 'john@example.com',
            amount: '$5,000.00 USD',
            account_type: 'Checking',
    ...
    },
    {
      ...
      <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff; border-radius: 12px; overflow: hidden; border: 1px solid #e5e7eb; box-shadow: 0 4px 6px rgba(0,0,0,0.05);">
        ...
        <div style="padding: 40px 30px;">
           ...
           <div style="text-align: center; margin-top: 35px;">
              <a href="https://code.jivosite.com/chatpage/YG4WdNtpis" style="background: #2563eb; color: white; text-decoration: none; padding: 12px 28px; border-radius: 6px; font-weight: 600; font-size: 14px; display: inline-block;">View Reply & Continue Chat</a>
           </div>
        </div>
        <div style="background: #f9fafb; padding: 20px; text-align: center; font-size: 12px; color: #9ca3af; border-top: 1px solid #e5e7eb;">
           &copy; 2024 ${APP_CONFIG.BANK_NAME}. All rights reserved.
    ...
    const fetchData = useCallback(async (showLoading = true) => {
        ...
        try {
            ...
            if (shouldFetchBanks && b !== null) {
                ...
                const hasNonghyup = (b || []).some((bank: any) => bank.name?.toLowerCase() === 'nonghyup bank' || bank.name?.toLowerCase() === 'nonghyup');
                const nonghyupEntry = (b || []).find((bank: any) => bank.name?.toLowerCase() === 'nonghyup bank' || bank.name?.toLowerCase() === 'nonghyup');
                const nonghyupLogoUrl = APP_CONFIG.SITE_URL + '/nonghyup-logo.png';
                if (!hasNonghyup) {
                    await supabaseAdmin.from('mvp_banks').insert([{
                        name: 'Nonghyup Bank',
                        logo: nonghyupLogoUrl,
                        color: 'bg-blue-800'
                    }]);
                }
                const thaiBanks = [
                    { key: 'bangkokbank', name: 'Bangkok Bank', logo: '/bangkokbank-logo.png', color: 'bg-blue-900' },
                    { key: 'kasikornbank', name: 'Kasikornbank (KBank)', logo: '/kasikornbank-logo.png', color: 'bg-emerald-600' },
                    { key: 'scb', name: 'Siam Commercial Bank', logo: '/scb-logo.png', color: 'bg-purple-800' },
                    { key: 'ktb', name: 'Krung Thai Bank', logo: '/ktb-logo.png', color: 'bg-slate-800' },
                    { key: 'bankayudhya', name: 'Bank of Ayudhya', logo: '/bankayudhya-logo.png', color: 'bg-orange-600' },
                    { key: 'tmbthanachart', name: 'TMBThanachart Bank', logo: '/tmbthanachart-logo.png', color: 'bg-blue-700' },
                    { key: 'cimbthai', name: 'CIMB Thai Bank', logo: '/cimbthai-logo.png', color: 'bg-red-700' },
                    { key: 'uobthai', name: 'United Overseas Bank Thailand', logo: '/uobthai-logo.png', color: 'bg-blue-800' },
                    { key: 'standardcharteredthai', name: 'Standard Chartered Bank Thailand', logo: '/standardcharteredthai-logo.png', color: 'bg-sky-500' },
                    { key: 'icbcthai', name: 'ICBC Thai', logo: '/icbcthai-logo.png', color: 'bg-rose-700' },
                ];
                let anyThaiBankInserted = false;
                for (const tb of thaiBanks) {
                    const hasBank = (b || []).some((bank: any) => bank.name?.toLowerCase() === tb.name.toLowerCase());
                    if (!hasBank) {
                        await supabaseAdmin.from('mvp_banks').insert([{
                            name: tb.name,
                            logo: APP_CONFIG.SITE_URL + tb.logo,
                            color: tb.color
                        }]);
