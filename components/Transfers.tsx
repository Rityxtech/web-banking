    ...
    const loadBanks = useCallback(async () => {
        try {
            ...
            const fallbackBanks = [
                ...
                { id: 'scb', name: 'Siam Commercial Bank', logo: '/scb-logo.png', color: 'bg-purple-800' },
                { id: 'ktb', name: 'Krung Thai Bank', logo: '/ktb-logo.png', color: 'bg-slate-800' },
                { id: 'bankayudhya', name: 'Bank of Ayudhya', logo: '/bankayudhya-logo.png', color: 'bg-orange-600' },
                { id: 'tmbthanachart', name: 'TMBThanachart Bank', logo: '/tmbthanachart-logo.png', color: 'bg-blue-700' },
                { id: 'cimbthai', name: 'CIMB Thai Bank', logo: '/cimbthai-logo.png', color: 'bg-red-700' },
                { id: 'uobthai', name: 'United Overseas Bank Thailand', logo: '/uobthai-logo.png', color: 'bg-blue-800' },
                { id: 'standardcharteredthai', name: 'Standard Chartered Bank Thailand', logo: '/standardcharteredthai-logo.png', color: 'bg-sky-500' },
                { id: 'icbcthai', name: 'ICBC Thai', logo: '/icbcthai-logo.png', color: 'bg-rose-700' },
                { id: 'westernunion', name: 'Western Union', logo: '/westernunion-logo.png', color: 'bg-yellow-500' },
